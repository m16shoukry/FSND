...
def create_app(test_config=None):
  ...
  def create_question():
      ...
      if question is None or answer is None or len(question) == 0 or len(answer) == 0 or category < 0 or not difficulty.isnumeric() or int(difficulty) < 1 or int(difficulty) > 5:
        abort(422)
